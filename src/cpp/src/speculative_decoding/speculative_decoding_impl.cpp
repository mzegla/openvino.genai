...
ContinuousBatchingPipeline::SpeculativeDecodingImpl::add_request(uint64_t request_id,
    ...
    // NOT IMPLEMENTED - think about other way of handling Whisper with Speculative Decoding
    return m_main_pipeline->add_request(request_id, input_ids, GenerationConfig());
}
